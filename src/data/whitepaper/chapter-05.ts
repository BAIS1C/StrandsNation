...
<p>Fourth, it integrates with the Mymories vault for persistent memory across sessions. Architectural decisions made in one session are filed to the vault. Subsequent sessions retrieve them rather than reconstructing them.</p>
...
<h2>Mymories as the Context Substrate</h2>
...
<p>The Mymories vault is mounted as the source of truth for Strands but is not yet always available during Cowork sessions. Mounting it consistently across all relevant sessions is a current operational concern. The vault MCP integration is in active build to make this seamless.</p>
