...
export default function MaitsSection() {
  return (
    <div>
      ...
      <Card variant="yellow">
        <div className={styles.cardTitleMd} data-variant="yellow">MyMory</div>
        <p className={styles.body}>
          MyMory is the semantic memory vault powering every persistent interaction in Strands.
      ...
      <Card variant="cyan">
        <div className={styles.cardTitleMd} data-variant="cyan">MyMory Chrome Extension</div>
        <p className={styles.body}>
          Start building your personal memory graph outside the game. The MyMory Chrome Extension
        ...
        <p className={styles.body} style={{ fontSize: '0.85rem', opacity: 0.8 }}>
          ...
          4. If updating: click &ldquo;Remove&rdquo; on the old version of MyMory.<br />
